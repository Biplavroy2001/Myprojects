...
fun CGPA(semesters: MutableList<Semester>) {
    var grade1 by remember1 {mutableStateOf("") }
    var credit1 by remember { mutableStateOf<Int?>(null)}
    var grade2 by remember1 {mutableStateOf("") }
    var credit2 by remember { mutableStateOf<Int?>(null)}
    var grade3 by remember1 {mutableStateOf("") }
    var credit3 by remember { mutableStateOf<Int?>(null)}
    var grade4 by remember1 {mutableStateOf("") }
    ...
    Column(modifier = Modifier
        ...
        Text(
            text = "Hello there!\n Welcome to my App", modifier = Modifier.fillMaxWidth(),
            style = TextStyle(
            ...
            Column (modifier = Modifier.fillMaxHeight(), verticalArrangement = Arrangement.SpaceBetween){
                Button(onClick = { /*TODO*/
                 val semester=Semester(grade1,credit1 ?: 0)
                    ...
                    if (totalCredit >0){
                        cgpa = totalGradePoint / totalGradePoint.toDouble()
                    }else{
                        cgpa = 0.0
                    }
                    ...
                    Text(text = "Calculate CGPA", fontSize = 16.sp, color = Color.Black, fontFamily = FontFamily(Font(R.font.poppins_medium)) )

                }
                Surface (modifier = Modifier
                    .width(177.dp)
                    .wrapContentHeight(), color = Color(0xFF263238), shape = RoundedCornerShape(15.dp)){
                    Text(text = "Your all time\n CGPA is:$cgpa", modifier = Modifier.padding(10.dp),
                        style=TextStyle(
            ...
            Column {
                ...
                Surface(
                    ...
                    Column {
                        ...
                        Text(
                            text = "Previous Semester", modifier = Modifier
                                .fillMaxWidth()
